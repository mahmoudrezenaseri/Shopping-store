...
import {health_category_list} from '../../data/dataArray';
  ...
  return (
    <Fragment>
      <View style={styles.head}>
        <Text style={styles.head_right}>آرایشی ، بهداشتی و سلامت</Text>
        <Text style={styles.head_left}>لیست کامل</Text>
      </View>
      <FlatList
        showsHorizontalScrollIndicator={false}
        horizontal={true}
        data={health_category_list}
...
export default React.memo(Category2);
