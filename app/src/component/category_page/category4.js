...
import {car_category_list} from '../../data/dataArray';
  ...
  return (
    <Fragment>
      <View style={styles.head}>
        <Text style={styles.head_right}>خودرو ، ابزار و اداری</Text>
        <Text style={styles.head_left}>لیست کامل</Text>
      </View>
      <FlatList
        horizontal={true}
        showsHorizontalScrollIndicator={false}
        data={car_category_list}
...
export default React.memo(Category4);
